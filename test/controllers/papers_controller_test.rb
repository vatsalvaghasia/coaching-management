...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { category_id: @paper.category_id, description: @paper.description, month_id: @paper.month_id, title: @paper.title, year_id: @paper.year_id } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { category_id: @paper.category_id, description: @paper.description, month_id: @paper.month_id, title: @paper.title, year_id: @paper.year_id } }
