...
class MonthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post months_url, params: { month: { month_name: @month.month_name, month_number: @month.month_number } }
    end
  ...
  test "should update month" do
    patch month_url(@month), params: { month: { month_name: @month.month_name, month_number: @month.month_number } }
